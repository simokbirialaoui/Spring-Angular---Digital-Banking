...
public class BankAccountMapperImpl {
    ...
    public SanvingBankAccountDTO fromSavingBankAccount(SavingAccount savingAccount){
        SanvingBankAccountDTO savingBankAccountDTO=new SanvingBankAccountDTO();
    ...
    public SavingAccount fromSavingBankAccountDTO(SanvingBankAccountDTO savingBankAccountDTO){
